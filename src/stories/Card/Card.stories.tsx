...
const TemplateOutlined = (args: JSX.IntrinsicAttributes & CardType) => <Card {...args} />;

export const Outlined: { args: CardType } | any = TemplateOutlined.bind({});
Outlined.args = {
  use: 'outlined',
  title: 'title',
  secondary: 'secondary',
...
const TemplateMedia = (args: JSX.IntrinsicAttributes & CardType) => <Card {...args} />;

export const Media: { args: CardType } | any = TemplateMedia.bind({});
Media.args = {
  use: 'outlined',
  title: 'title',
  secondary: 'secondary',
